...
<div className="group flex w-full cursor-pointer flex-col transition-all duration-300 hover:scale-105">
  <div className="relative mb-4">
    <div className="relative overflow-hidden rounded-xl aspect-[3/2] border...">
      <Image className="object-cover transition-transform duration-300 group-hover:scale-110" />
    </div>
  </div>
  <article className="flex w-full flex-grow flex-col space-y-3">
...
**After (Fixed)**:
```tsx
<div className="group bg-white dark:bg-neutral-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-neutral-200 dark:border-neutral-700">
