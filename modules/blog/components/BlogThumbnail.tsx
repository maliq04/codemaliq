  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div className="group-hover:shadow-3xl blog-featured-hero relative w-full overflow-hidden rounded-2xl shadow-2xl transition-all duration-300">
          <Image
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
            <div className="max-w-4xl">
              ...
              <p className="mb-6 max-w-3xl text-lg leading-relaxed text-white/90 md:text-xl lg:text-2xl">
              ...
              <div className="flex flex-wrap items-center gap-6 text-base text-white/90">
                ...
                <div className="flex items-center gap-2">
                  <CommentIcon size={18} />
                  <span>
                    {newestBlog.comments_count} Comment{newestBlog.comments_count !== 1 ? 's' : ''}
                  </span>
                </div>
              ...
              {/* Call to action */}
              <div className="mt-8">
                <div className="inline-flex items-center gap-3 rounded-xl border border-white/20 bg-white/10 px-6 py-3 text-lg font-semibold text-white backdrop-blur-sm transition-all duration-300 group-hover:scale-105 group-hover:bg-white/20">
                  Read Full Article
                  <svg
