...
import { CODEMALIQ_SERVICE } from '@/common/constant'
import { METADATA } from '@/common/constant/metadata'
import { getRequestHeader } from '@/common/helpers'
import { careerDto } from '@/common/helpers/dto'
import { IResponseCodeMaliqService } from '@/common/types'
...
async function getCareers(): Promise<ICareer[]> {
  ...
  const response = await axios.get(`${CODEMALIQ_SERVICE}/career`, { headers })
  const data = response.data as IResponseCodeMaliqService<ICareerCMS[]>
